...
function showInformation(){
    ...
    $.ajax({
        ...
        success:function(data){
            if(data[0].u_sex==1){
                $(".headp").html("<div><div id='head-pt1'><div><a href='changehead.html'><img src="+data[0].pc_src+" alt=''/></a></div> <div><a href='changehead.html'>修改头像</a></div></div> <div id='head-pt2'><div>用户ID：<span>"+data[0].u_uid+"</span></div><div>昵称：<span class='nickname'>"+data[0].u_nickname+"</span></div> <div>性别：<span>男</span></div><div>手机号：<span>"+data[0].u_tel+"</span></div><div>邮箱：<span>"+data[0].u_email+"</span></div></div></div><div id='head-pt3'>独白：<span>"+data[0].u_share+"</span></div>");
            }
            if(data[0].u_sex==0){
                $(".headp").html("<div><div id='head-pt1'><div><a href='changehead.html'><img src="+data[0].pc_src+" alt=''/></a></div> <div><a href='changehead.html'>修改头像</a></div></div> <div id='head-pt2'><div>用户ID：<span>"+data[0].u_uid+"</span></div><div>昵称：<span class='nickname'>"+data[0].u_nickname+"</span></div> <div>性别：<span>女</span></div><div>手机号：<span>"+data[0].u_tel+"</span></div><div>邮箱：<span>"+data[0].u_email+"</span></div></div></div><div id='head-pt3'>独白：<span>"+data[0].u_share+"</span></div>");
            }
        }
    })
}
